                ...
                <tr>
                    ...
                    <td>
                        <x-table-badge-list
                            ...
                            :empty-label="$scopeEmptyLabel($organization->program_scope_mode, 'All projects', 'No projects')"
                        />
                    </td>
                    <td>
                        <x-table-badge-list
                            ...
                            :empty-label="$scopeEmptyLabel($organization->program_scope_mode, 'All programs', 'No programs')"
                        />
                    </td>
                    <td>
