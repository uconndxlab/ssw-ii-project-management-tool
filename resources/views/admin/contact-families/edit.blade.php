...
@section('content')
@php
    $selectedProjectIds = old('project_ids', $contactFamily->projects->pluck('id')->toArray());
    $selectedProgramIds = old('program_ids', $contactFamily->programs->pluck('id')->toArray());
                ...
                <form method="POST" action="{{ route('contact-families.update', $contactFamily) }}" id="contact-families-edit-form">
                    ...
                    <div class="mb-4">
                        <x-project-program-scope-picker
                            scope-id="contact-family-edit-scope"
                            :projects="$projects"
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const programPicker = document.getElementById('contact-family-edit-scope-programs');
