...
<div class="card mb-4">
    <div class="card-body">
        ...
        @if($isEditMode)
            ...
            @else
                <div class="alert alert-light border mb-0">No attachments have been added yet.</div>
            @endif
        @else
            <div class="alert alert-light border mb-0">Attachments will appear here after the agreement is created.</div>
        @endif
    </div>
</div>
...
<div class="card mb-4">
    <div class="card-body">
        ...
        @else
            <div class="alert alert-light border mb-0">User assignment becomes available after the agreement is created.</div>
        @endif
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        @else
            <div class="alert alert-light border mb-0">Deliverables become available after the agreement is created.</div>
        @endif
    </div>
</div>
